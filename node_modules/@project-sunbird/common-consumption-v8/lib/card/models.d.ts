...
export declare enum LibraryCardTypes {
...
export declare enum CourseCardGridTypes {
...
export declare enum FlattenedType {
    EXPAND = "expand",
    COLLAPSE = "collapse"
}
...
export declare enum ExpandMode {
    SINGLE = "single",
    MULTIPLE = "multiple"
}
export declare enum ExpandBehavior {
    NONE = "none",
