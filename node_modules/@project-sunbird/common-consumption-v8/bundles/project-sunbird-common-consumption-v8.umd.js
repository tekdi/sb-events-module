(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/animations'), require('@angular/forms'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@project-sunbird/common-consumption-v8', ['exports', 'rxjs', '@angular/animations', '@angular/forms', '@angular/platform-browser', '@angular/common', '@angular/core'], factory) :
    (factory((global['project-sunbird'] = global['project-sunbird'] || {}, global['project-sunbird']['common-consumption-v8'] = {}),global.rxjs,global.ng.animations,global.ng.forms,global.ng.platformBrowser,global.ng.common,global.ng.core));
}(this, (function (exports,rxjs,animations,forms,platformBrowser,common,i0) { 'use strict';
    ...
    var CommonConsumptionService = /** @class */ (function () {
        ...
        /** @nocollapse */ CommonConsumptionService.ngInjectableDef = i0.ɵɵdefineInjectable({ factory: function CommonConsumptionService_Factory() { return new CommonConsumptionService(); }, token: CommonConsumptionService, providedIn: "root" });
    ...
    var LibraryCardComponent = /** @class */ (function () {
        ...
        LibraryCardComponent.propDecorators = {
            ...
            isOffline: [{ type: i0.Input }],
            cardImg: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
            moreInfoLabel: [{ type: i0.Input }],
            section: [{ type: i0.Input }],
            isLoading: [{ type: i0.Input }],
            gridTemplate: [{ type: i0.Input, args: ['hover-template',] }],
            btnlabel: [{ type: i0.Input }],
            btnicon: [{ type: i0.Input }],
            isMenu: [{ type: i0.Input }],
            layoutConfig: [{ type: i0.Input }],
            indexToDisplay: [{ type: i0.Input }],
    ...
    var CardHoverComponent = /** @class */ (function () {
        function CardHoverComponent() {
            this.hoverActionClick = new i0.EventEmitter();
            this.text = 'click';
        }
        /**
         * @return {?}
        ...
        CardHoverComponent.propDecorators = {
            hoverData: [{ type: i0.Input }],
            content: [{ type: i0.Input }],
            hoverActionClick: [{ type: i0.Output }]
        };
    ...
    */
    ...
    var TocCardComponent = /** @class */ (function () {
        function TocCardComponent() {
            ...
            this.tocCardClick = new i0.EventEmitter();
            this.playButtonClick = new i0.EventEmitter();
            this.scoreLabel = '';
            this.disabled = '';
        ...
        TocCardComponent.propDecorators = {
            content: [{ type: i0.Input }],
            activeContent: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
            contentStatus: [{ type: i0.Input }],
            refresh: [{ type: i0.Input }],
            playBtnConfig: [{ type: i0.Input }],
            trackableDefaultImage: [{ type: i0.Input }],
            platform: [{ type: i0.Input }],
            tocCardClick: [{ type: i0.Output }],
            playButtonClick: [{ type: i0.Output }],
            scoreLabel: [{ type: i0.Input }],
            maxAttempts: [{ type: i0.Input }],
    ...
    var CourseCuriculumCardComponent = /** @class */ (function () {
        ...
        CourseCuriculumCardComponent.propDecorators = {
            ...
            index: [{ type: i0.Input }],
            isActivityTypeCard: [{ type: i0.Input }],
            cardClick: [{ type: i0.Output }]
        };
    ...
    var GroupCardComponent = /** @class */ (function () {
        ...
        GroupCardComponent.propDecorators = {
            ...
            isSuspended: [{ type: i0.Input }],
            suspendBadgeText: [{ type: i0.Input }],
            cardClick: [{ type: i0.Output }]
        };
    ...
    var MemberCardComponent = /** @class */ (function () {
        ...
        MemberCardComponent.propDecorators = {
            ...
            isAdmin: [{ type: i0.Input }],
            isMenu: [{ type: i0.Input }],
            indexOfMember: [{ type: i0.Input }],
            initial: [{ type: i0.Input }],
            cardImg: [{ type: i0.Input }],
            identifier: [{ type: i0.Input }],
            selected: [{ type: i0.Input }],
            progressDisplay: [{ type: i0.Input }],
            progressSize: [{ type: i0.Input }],
            isLoading: [{ type: i0.Input }],
    ...
    var NotificationCardComponent = /** @class */ (function () {
        function NotificationCardComponent() {
            ...
            this.notificationClick = new i0.EventEmitter();
            this.deleteNotificationClick = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        NotificationCardComponent.propDecorators = {
            ...
            notificationClick: [{ type: i0.Output }],
            deleteNotificationClick: [{ type: i0.Output }]
        };
    ...
    var LibraryCardsStackComponent = /** @class */ (function () {
        function LibraryCardsStackComponent() {
            ...
            this.viewMoreClick = new i0.EventEmitter();
            this.cardClick = new i0.EventEmitter();
            this.menuClick = new i0.EventEmitter();
        }
        ...
        LibraryCardsStackComponent.propDecorators = {
            contentList: [{ type: i0.Input }],
            title: [{ type: i0.Input }],
            isOffline: [{ type: i0.Input }],
            viewMoreButtonText: [{ type: i0.Input }],
            maxCardCount: [{ type: i0.Input }],
            isLoading: [{ type: i0.Input }],
            isMenu: [{ type: i0.Input }],
            layoutConfig: [{ type: i0.Input }],
            cardType: [{ type: i0.Input }],
            viewMoreClick: [{ type: i0.Output }],
            cardClick: [{ type: i0.Output }],
            menuClick: [{ type: i0.Output }]
        };
    ...
    var CourseCardsHlistComponent = /** @class */ (function () {
        ...
        CourseCardsHlistComponent.propDecorators = {
            ...
            hideProgress: [{ type: i0.Input }],
            isMenu: [{ type: i0.Input }],
            viewMoreButtonPosition: [{ type: i0.Input }],
            viewMoreClick: [{ type: i0.Output }],
            cardClick: [{ type: i0.Output }],
            menuClick: [{ type: i0.Output }]
        };
    ...
    var InAppNotificationComponent = /** @class */ (function () {
        function InAppNotificationComponent() {
            ...
            this.notificationClick = new i0.EventEmitter();
            this.deleteNotificationClick = new i0.EventEmitter();
            this.clearAllClick = new i0.EventEmitter();
            this.showMore = new i0.EventEmitter();
            this.showLess = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        InAppNotificationComponent.propDecorators = {
            notificationList: [{ type: i0.Input }],
            inAppNotificationConfig: [{ type: i0.Input }],
            notificationClick: [{ type: i0.Output }],
            deleteNotificationClick: [{ type: i0.Output }],
            clearAllClick: [{ type: i0.Output }],
            showMore: [{ type: i0.Output }],
            showLess: [{ type: i0.Output }]
        };
    ...
    var LibraryFiltersComponent = /** @class */ (function () {
        function LibraryFiltersComponent() {
            ...
            this.selectedMimeType = new i0.EventEmitter();
    ...
    var TocItemComponent = /** @class */ (function () {
        function TocItemComponent() {
            ...
            this.tocCardClick = new i0.EventEmitter();
            this.noContent = new i0.EventEmitter();
             ...
             */function (currentContent) {
                return _this.activeMimeTypeFilter.find(( /**
                 * @param {?} mimeType
                 * @return {?}
        ...
        TocItemComponent.propDecorators = {
            accordianConfig: [{ type: i0.Input }],
            accordionItems: [{ type: i0.ViewChildren, args: ['sbAccordionItem',] }],
            tocData: [{ type: i0.Input }],
            activeMimeTypeFilter: [{ type: i0.Input }],
            noContentMessage: [{ type: i0.Input }],
            contentStatus: [{ type: i0.Input }],
            ...
            platform: [{ type: i0.Input }],
            trackableDefaultImage: [{ type: i0.Input }],
            divs: [{ type: i0.ViewChild, args: ['chapter', { static: false },] }],
            chapterContainer: [{ type: i0.ViewChildren, args: ['chapterContainer',] }],
            type: [{ type: i0.Input }],
            activeContent: [{ type: i0.Input }],
            recogniseCollection: [{ type: i0.Input }],
            tocCardClick: [{ type: i0.Output }],
            noContent: [{ type: i0.Output }],
    ...
    var AccordionItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AccordionItemComponent.ctorParameters = function () {
            return [
                { type: AccordionComponent, decorators: [{ type: i0.Host }] }
            ];
        };
    ...
    var AccordionHeaderComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AccordionHeaderComponent.ctorParameters = function () {
            return [
                { type: AccordionItemComponent, decorators: [{ type: i0.Host }] }
            ];
        };
    ...
    var AccordionBodyComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AccordionBodyComponent.ctorParameters = function () {
            return [
                { type: AccordionItemComponent, decorators: [{ type: i0.Host }] }
            ];
        };
    ...
    var TocCurriculumComponent = /** @class */ (function () {
        ...
        TocCurriculumComponent.propDecorators = {
            ...
            activeMimeTypeFilter: [{ type: i0.Input }],
            noContentMessage: [{ type: i0.Input }],
            isAccordion: [{ type: i0.Input }],
            isChapterListing: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
            contentStatus: [{ type: i0.Input }],
            shadowColor: [{ type: i0.Input }],
            progressColor: [{ type: i0.Input }],
            refresh: [{ type: i0.Input }],
            layoutConfig: [{ type: i0.Input }],
            playBtnConfig: [{ type: i0.Input }],
            platform: [{ type: i0.Input }],
    ...
    var FaqComponent = /** @class */ (function () {
        function FaqComponent() {
            ...
            this.toggleGroupEvent = new i0.EventEmitter();
            this.yesClickedEvent = new i0.EventEmitter();
            this.noClickedEvent = new i0.EventEmitter();
            this.submitClickedEvent = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        FaqComponent.propDecorators = {
            ...
            extraTemplate: [{ type: i0.Input }],
            toggleGroupEvent: [{ type: i0.Output }],
            yesClickedEvent: [{ type: i0.Output }],
            noClickedEvent: [{ type: i0.Output }],
            submitClickedEvent: [{ type: i0.Output }]
        };
        return FaqComponent;
    }());
    ...
    var CertificateActionsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CertificateActionsComponent.ctorParameters = function () {
            return [
        ...
        CertificateActionsComponent.propDecorators = {
            ...
            isSelectedTemplate: [{ type: i0.Input }],
            actionButtons: [{ type: i0.Input }],
            buttonClick: [{ type: i0.Output }]
        };
    ...
    var PillsGridComponent = /** @class */ (function () {
        function PillsGridComponent() {
            ...
            this.viewMorePillList = new i0.EventEmitter();
        }
        ...
        PillsGridComponent.propDecorators = {
            pillItems: [{ type: i0.ContentChildren, args: [PillItemComponent,] }],
            pillShape: [{ type: i0.Input }],
            pillsViewType: [{ type: i0.Input }],
            pillBorder: [{ type: i0.Input }],
            selectMode: [{ type: i0.Input }],
            pillsMultiRow: [{ type: i0.Input }],
            minDisplayCount: [{ type: i0.Input }],
            viewMoreText: [{ type: i0.Input }],
            viewLessText: [{ type: i0.Input }],
            showMoreViewType: [{ type: i0.Input }],
            select: [{ type: i0.Output }],
            viewMorePillList: [{ type: i0.Output }]
        };
    ...
    exports.CommonConsumptionService = CommonConsumptionService;
    exports.CommonConsumptionModule = CommonConsumptionModule;
    exports.LibraryFiltersComponent = LibraryFiltersComponent;
    exports.LibraryFiltersLayout = LibraryFiltersLayout;
    exports.TocMimeTypes = TocMimeTypes;
    exports.LibraryCardTypes = LibraryCardTypes;
    exports.CourseCardGridTypes = CourseCardGridTypes;
    exports.CardGridTypes = CardGridTypes;
    exports.CourseCardTypes = CourseCardTypes;
    exports.LibraryCardGridTypes = LibraryCardGridTypes;
    exports.LibraryCardStackTypes = LibraryCardStackTypes;
    exports.TocCardType = TocCardType;
    ...
    exports.ExpandBehavior = ExpandBehavior;
    exports.ButtonPosition = ButtonPosition;
    exports.ActionButtonType = ActionButtonType;
    exports.COMMON_CONSUMPTION_CONSTANTS = COMMON_CONSUMPTION_CONSTANTS;
    exports.PillsGridModule = PillsGridModule;
    exports.PillShape = PillShape;
    exports.PillsViewType = PillsViewType;
    exports.PillBorder = PillBorder;
    exports.SelectMode = SelectMode;
    exports.PillsMultiRow = PillsMultiRow;
    exports.ShowMoreViewType = ShowMoreViewType;
    exports.ɵbg = AccordionBodyComponent;
    exports.ɵbf = AccordionHeaderComponent;
    exports.ɵbe = AccordionItemComponent;
    exports.ɵbd = AccordionComponent;
    exports.ɵbc = AccordionModule;
    exports.ɵd = CardHoverComponent;
    exports.ɵa = CardModule;
    exports.ɵc = CourseCardComponent;
    exports.ɵg = CourseCuriculumCardComponent;
    exports.ɵh = GroupCardComponent;
    exports.ɵj = LibraryCardV2Component;
    exports.ɵb = LibraryCardComponent;
    exports.ɵi = MemberCardComponent;
    exports.ɵf = MyCourseCardComponent;
    exports.ɵk = NotificationCardComponent;
    exports.ɵe = TocCardComponent;
    exports.ɵbm = CertificateActionsModule;
    exports.ɵbn = CertificateActionsComponent;
    exports.ɵw = ContentDetailsModule;
    exports.ɵx = PlayerActionsComponent;
    exports.ɵba = TocChildItemComponent;
    exports.ɵbb = TocCurriculumComponent;
    exports.ɵy = TocItemComponent;
    exports.ɵbi = FaqModule;
    exports.ɵbj = FaqComponent;
    exports.ɵs = CardsGridComponent;
    exports.ɵq = CourseCardsHlistComponent;
    exports.ɵt = InAppNotificationComponent;
    exports.ɵn = LayoutModule;
    exports.ɵp = LibraryCardsGridComponent;
    exports.ɵu = LibraryCardsHlistComponent;
    exports.ɵo = LibraryCardsStackComponent;
    exports.ɵr = MemberListComponent;
    exports.ɵv = LibraryFiltersModule;
    exports.ɵm = ConfirmationModalComponent;
    exports.ɵl = ModalModule;
    exports.ɵbl = InfoComponent;
    exports.ɵbk = PagesModule;
    exports.ɵbp = PillItemComponent;
    exports.ɵbo = PillsGridComponent;
    exports.ɵz = MimeTypePipe;
    exports.ɵbh = PipesModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=project-sunbird-common-consumption-v8.umd.js.map