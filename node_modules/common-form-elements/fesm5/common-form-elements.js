...
var DynamicFormComponent = /** @class */ (function () {
    ...
    function (code, depends) {
        /** @type {?} */
        var dependsTerms = map$1(filter(this.flattenSectionFields, (/**
         * @param {?} c
         * @return {?}
         */
        function (c) {
...
var DynamicDropdownComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (!isEmpty(this.depends)) {
            this.contextValueChangesSubscription = merge.apply(void 0, __spread(map$1(this.depends, (/**
             * @param {?} depend
             * @return {?}
             */
            ...
            function (value) {
                ...
                _this.isDependsInvalid = includes(map$1(_this.depends, (/**
                 * @param {?} depend
                 * @return {?}
                 */
    ...
    function () {
        ...
        if (!isEmpty(this.depends)) {
            /** @type {?} */
            var filteredTerm = find(this.dependencyTerms, (/**
             * @param {?} terms
             * @return {?}
             */
            function (terms) {
                return !isEmpty(_this.field.output) ?
                    includes(_this.getParentValue(), terms[_this.field.output]) :
                    includes(_this.getParentValue(), terms.name);
            }));
            if (filteredTerm) {
...
var DynamicMultipleDropdownComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (!isEmpty(this.depends)) {
            merge.apply(void 0, __spread(map$1(this.depends, (/**
             * @param {?} depend
             * @return {?}
             */
            function (depend) { return depend.valueChanges; })))).pipe(tap((/**
    ...
    function () {
        ...
        if (this.isOptionsArray()) {
            /** @type {?} */
            var optionMap = map$1(this.options, (/**
             * @param {?} option
             * @return {?}
             */
            function (option) {
            ...
            function (options) {
                ...
                function (option) {
                    /** @type {?} */
                    var value = !isEmpty(_this.field.output) ? option.get(_this.field.output) :
...
var TopicpickerComponent = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var selectedTopics = reduce(this.default, (/**
         * @param {?} collector
         * @param {?} element
         * @return {?}
         */
    ...
    function (data) {
        ...
        $(".topic-picker-selector_" + this.field.code).treePicker({
            ...
            function (selectedNodes) {
                ...
                _this.selectedTopics = map$1(selectedNodes, (/**
                 * @param {?} node
                 * @return {?}
                 */
    ...
    function () {
        ...
        if (!isEmpty(this.depends)) {
             ...
             */
            function (terms) {
                return !isEmpty(_this.field.output) ? includes(_this.getParentValue(), terms[_this.field.output]) :
                    includes(_this.getParentValue(), terms.name);
            }));
            if (filteredTerm) {
                this.tempAssociation = filter(filteredTerm.associations, (/**
...
var DynamicMultiSelectComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (!isEmpty(this.depends)) {
             ...
             */
            function (terms) {
                return includes(_this.getParentValue(), terms.identifier);
            }));
            if (filteredTerm) {
                this.tempAssociation = filter(filteredTerm.associations, (/**
                 * @param {?} association
